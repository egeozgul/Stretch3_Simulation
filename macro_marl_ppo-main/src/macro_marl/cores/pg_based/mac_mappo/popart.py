"""
This file is from github.com/marlbenchmark/on-policy/blob/main/onpolicy/algorithms/utils/popart.py
"""
...
class PopArt(torch.nn.Module):
    ...
    def update(self, input_vector):
        ...
        self.bias.mul_(old_stddev).add_(old_mean - new_mean).mul_(1 / new_stddev)
