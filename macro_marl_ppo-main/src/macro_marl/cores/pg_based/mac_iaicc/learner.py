...
class Learner(object):
    ...
    def __init__(self, 
        ...
        # Dual-critic return handling toggles (matches mac_iac / acac semantics).
        ...
        print(f"[mac_iaicc Learner] USE_CHAIN_BREAK={int(self.use_chain_break)} "
    ...
    def _set_optimizer(self):
        for agent in self.controller.agents:
            ...
            # critics receive gradients from the per-step-selected V_value loss.
            critic_params = list(agent.critic_net.parameters())
            if hasattr(agent, 'normal_critic_net'):
                critic_params += list(agent.normal_critic_net.parameters())
