...
This code base is adapted from MacroMARL (https://github.com/yuchen-x/MacroMARL): MacroMARL is a framework for deep multi-agent reinforcement learning that allows agents to asynchronously learn and execution with Macro-Actions. This framework includes implementations of the following algorithms:
...
- Policy-Gradient-Based Approaches:
  ...
  - [**MAPPO**, **IPPO**, and **ACAC**: Macro-Action-Based Deep Multi-Agent Reinforcement Learning with Multi-Agent and Independent PPO. Agent-Centric Actor-Critic (ACAC) for Asynchronous Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2209.10113)
...
Install typing-exptensions package:
```
pip install typing-extensions
Install remaining pip packages if it complains
```
