#!/usr/bin/env python3
"""Launch Nav2 global planners plus FollowPath controllers for both Stretch robots."""
...
def _robot_nodes(namespace, params_file, x_arg, y_arg, yaw_arg):
    return [
        Node(
            package='tf2_ros',
...
def generate_launch_description():
    ...
    stretch_params = os.path.join(repo_dir, 'nav2_local_planner_params.yaml')
    stretch2_params = os.path.join(repo_dir, 'nav2_local_planner_params_stretch2.yaml')
    ...
    return LaunchDescription([
        ...
        *_robot_nodes('stretch', stretch_params, 'map_to_odom_x', 'map_to_odom_y', 'map_to_odom_yaw'),
        *_robot_nodes('stretch2', stretch2_params, 'r2_map_to_odom_x', 'r2_map_to_odom_y', 'r2_map_to_odom_yaw'),
        Node(
            package='rviz2',
            executable='rviz2',
            name='rviz2_two_robot_local_planner',
            output='screen',
